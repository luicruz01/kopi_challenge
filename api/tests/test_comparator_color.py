...
class TestComparatorColor:
    ...
    def test_blue_better_than_red(self):
        ...
        axis_terms = ["simplicity", "consistency", "accessibility", "essential", "practice", "interruptions"]
    ...
    def test_neutral_color_vs(self):
        ...
        color_in_axis = ("blue" in response_lower and "red" in response_lower and 
                        any(axis in response_lower for axis in ["consistency", "simplicity", "accessibility"]))
    ...
    def test_no_color_specific_arguments(self):
        ...
        color_specific_terms = [
            "calm and trust", "visual fatigue", "urgency and action", 
            "dashboard", "warnings", "call-to-action"
        ]
    ...
    def test_multiple_color_words(self):
        ...
        for user_message, expected_colors in test_cases:
            ...
            if comparator_match:
                ...
                color_detected = any(color.lower() in [a_lower, b_lower] for color in expected_colors)
                assert color_detected, f"Should detect compound color names in '{user_message}': {comparator_match}"
    ...
    def test_no_unrelated_topics(self):
        ...
        for user_message in color_comparisons:
            ...
            forbidden_topics = [
                "technology", "climate", "education", "environment", 
                "carbon", "spirituality", "meditation"
            ]
            ...
            axis_focus = any(term in response_lower for term in ["simplicity", "consistency", "practice", "results"])
