...
TOPIC_DATA: dict[str, dict[str, dict[str, list[str]]]] = {
    "en": {
        "climate": {
            ...
            "questions": [
                "we can afford to ignore environmental consequences",
                "future generations matter",
                "planet health is important",
            ],
        },
        "technology": {
            "keywords": [
            ...
            "questions": [
                "progress should be halted due to minor concerns",
        ...
        "education": {
            ...
            "questions": [
                "knowledge should be restricted rather than shared",
        ...
        "general": {
            ...
            "questions": [
                "we should avoid necessary improvements",
    ...
    "es": {
        "climate": {
            ...
            "questions": [
                "podemos ignorar las consecuencias ambientales",
                "las futuras generaciones importan",
                "la salud del planeta es importante",
            ],
        },
        "technology": {
            "keywords": [
            ...
            "analogies": [
                ...
                "adoptar mejores métodos",
            ],
            "principles": ["mejora continua", "adaptación al cambio", "adopción del progreso"],
            "questions": [
                "el progreso debe detenerse por preocupaciones menores",
                "la innovación beneficia a la sociedad",
        ...
        "education": {
            ...
            "questions": [
                "el conocimiento debe restringirse en lugar de compartirse",
                "la educación mejora vidas",
        ...
        "general": {
            ...
            "questions": [
                "debemos evitar mejoras necesarias",
